...
function Features() {
  ...
  return (
    <section className="py-12">
      <div className="">
        <div className="mb-4 lg:mb-4 flex justify-center items-center flex-col gap-x-0 gap-y-6 lg:gap-y-0 lg:flex-row lg:justify-between max-md:max-w-lg max-md:mx-auto">
        ...
        <div className="flex justify-center items-center gap-x-5 gap-y-6 lg:gap-y-0 flex-wrap md:flex-wrap lg:flex-nowrap lg:flex-row lg:justify-between lg:gap-x-8 ">
          <div className="group relative w-full bg-gray-200 rounded-2xl p-4 transition-all duration-500 max-md:max-w-md max-md:mx-auto md:w-2/5 md:h-64 xl:p-7 xl:w-1/3 hover:bg-orange-600 ">
            ...
            <h4 className="text-xl font-semibold text-sky-800 mb-3 capitalize transition-all duration-500 group-hover:text-white">
