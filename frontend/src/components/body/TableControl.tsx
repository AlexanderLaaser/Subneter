  ...
  return (
    <div className="flex  sm:flex-col pt-10 font-montserrat xl:space-x-10 xl:flex-row">
      ...
      >
        ...
        <button className="inline-flex items-center justify-center pr-4 pl-4 h-10 text-slate-50 transition-colors duration-150 bg-sky-800 rounded-lg focus:shadow-outline hover:bg-orange-600">
